...
/**
 * Fungsi untuk memperbarui detail kursus (digunakan oleh EditCourseModal)
 */
export async function updateCourse(
  ...
  const { error } = await supabase
    ...
    .update(values)
    .eq("id", courseId)
    .eq("instructor_id", userId); // Tambahan keamanan agar hanya pemilik yang bisa edit
  ...
  // Refresh path agar data di halaman setup langsung berubah
